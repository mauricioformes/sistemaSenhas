        ...
        init: function () {
            ...
            $(e.element).each( function(i,o) {
                ...
                $(o).find("tr").not(e.settings.exclude).each(function (i,p) {
					...
					// Reset for this row
					additionalStyles = "font-family: Verdana;";
					
					// Preserve background and text colors on the row
					if(e.settings.preserveColors){
						compStyle = getComputedStyle(p);
						additionalStyles += (compStyle && compStyle.backgroundColor ? "background-color: " + compStyle.backgroundColor + "; font-family: Verdana;" : "");
						additionalStyles += (compStyle && compStyle.color ? "color: " + compStyle.color + "; font-family: Verdana;" : "");
					}
