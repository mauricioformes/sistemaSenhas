...
class Statement extends \PDOStatement implements \IteratorAggregate
{
     ...
     * @return bool bound
     */
    public function bindParam($param, &$value, $type=null, $leng=null,$driverdata = null)
    {
     ...
     * @throws \PDOException
     */
    public function fetch($style=null,$argument=null,$ofsset=null)
    {
        set_error_handler(array($this->_pdooci,"errorHandler"));
        try {
            ...
            case \PDO::FETCH_CLASS:
                $rst = \oci_fetch_array($this->_stmt, \OCI_ASSOC + \OCI_RETURN_NULLS);
                $rst  = $this->_createObjectFromData($argument, $rst);
                break;
            }
            $this->_current = $rst;
            $this->_checkBinds();
