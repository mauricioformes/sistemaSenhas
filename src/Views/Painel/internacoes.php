...
<body>
    <div class="contentpanel">
        <div class="panel panel-default">
            <br>
            <form name='formSelecionaGuicheInternacao' id="formSelecionaGuicheInternacao" class="form-horizontal">
    ...
    <div class="contentpanel" id="exibeFilaInternacao" hidden>
                    ...
                    <div class="col-md-12">
                        <div>
                            <table class="table parametrizacao table-bordered table-striped table-dark">
                                ...
                                <tbody id="exibeSenhasInternacao" name="exibeSenhasInternacao">
...
<div class="modal fade" id="modal_encaminhar_internacao" tabindex="-1" aria-labelledby="modal_encaminhar_internacao_procedLabel" data-backdrop="static" aria-hidden="false">
    <div class="modal-dialog modal-sg">
        <div class="modal-content ">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="modal_encaminhar_internacao_procedLabel"><span class="glyphicon glyphicon-pencil  text-info"></span> <span id="modal-titulo" class=" text-info">Detalhes</span></h4>
            </div>
            <div class="modal-body">
                <div id="mensagem_detalhe" style="overflow-y:none">
                    <form name='formEncaminharSenhaInternacao' id="formEncaminharSenhaInternacao" class="form-horizontal">
                        <input type="hidden" name="codSenhaEncaminhaInternacao" id="codSenhaEncaminhaInternacao">
                        <input type="hidden" name="codGuicheEncaminhaInternacao" id="codGuicheEncaminhaInternacao">
                        <input type="hidden" name="codLocalOrigemInternacao" id="codLocalOrigemInternacao">
                        <input type="hidden" name="codTipo" id="codTipo" value="3">

                        <div class=" form-group" id="linha_processo">

                            <label class="col-md-1 col-sm-1 control-label">Fila:</label>
                            <div class="col-md-6 col-sm-6">
                                <select name="codLocalEncaminhaInternacao" id="codLocalEncaminhaInternacao" class="form-control" required>
