...
<head>
    ...
    <title>Senhas - Assistencial</title>
</head>
...
<body>
    <div class="contentpanel">
        <div class="panel panel-default">
            <br>
            <form name='formSelecionaGuicheAssistencial' id="formSelecionaGuicheAssistencial" class="form-horizontal">
    ...
    <div class="contentpanel" id="exibeFilaAssistencial" hidden>
                    ...
                    <div class="col-md-12">
                        <div>
                            <table class="table parametrizacao table-bordered table-striped table-dark">
                                ...
                                <tbody id="exibeSenhasAssistencial" name="exibeSenhasAssistencial">
...
<div class="modal fade" id="modal_encaminhar_assistencial" tabindex="-1" aria-labelledby="modal_encaminhar_assistencial_procedLabel" data-backdrop="static" aria-hidden="false">
    <div class="modal-dialog modal-sg">
        <div class="modal-content ">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="modal_encaminhar_assistencial_procedLabel"><span class="glyphicon glyphicon-pencil  text-info"></span> <span id="modal-titulo" class=" text-info">Detalhes</span></h4>
            </div>
            <div class="modal-body">
                <div id="mensagem_detalhe" style="overflow-y:none">
                    <form name='formEncaminharSenhaAssistencial' id="formEncaminharSenhaAssistencial" class="form-horizontal">
                        <input type="hidden" name="codSenhaEncaminhaAssistencial" id="codSenhaEncaminhaAssistencial">
                        <input type="hidden" name="codGuicheEncaminhaAssistencial" id="codGuicheEncaminhaAssistencial">
                        <input type="hidden" name="codLocalOrigemAssistencial" id="codLocalOrigemAssistencial">
                        <input type="hidden" name="codTipo" id="codTipo" value="2">

                        <div class=" form-group" id="linha_processo">

                            <label class="col-md-1 col-sm-1 control-label">Fila:</label>
                            <div class="col-md-6 col-sm-6">
                                <select name="codLocalEncaminhaAssistencial" id="codLocalEncaminhaAssistencial" class="form-control" required>
